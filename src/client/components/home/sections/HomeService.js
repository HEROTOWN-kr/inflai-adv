...
function HomeService(props) {
  ...
  return (
    <Box padding={{ xs: '50px 16px', md: '100px 16px' }} className="service-cards" color="#fff">
      <Box textAlign="center" mb={2} fontSize={{ xs: '7vw', md: '48px' }} fontWeight="700">나에게 딱 맞는 인플루언서를 만나보세요</Box>
